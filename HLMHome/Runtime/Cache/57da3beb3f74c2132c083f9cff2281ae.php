...
<div class="register">
	<div class="blank">
    <div class="white">
		<div class="title"><span id="title">新用户注册</span></div>
		<div class="info"> 
			<div class="row">
			...
			<div class="row">
				...
				<input class="value" type="password" id="passwordrepeat"/>
				<span class="tip" id="passwordrepeatalert"></span>
			</div>
			<div class="row">
...
<script src="__JS__/auth/register.js?t=1398089905"></script>
